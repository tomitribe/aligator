...
public class MoviesRest {
    ...
    @See(href = "endpoint/moviefun-rest/GET/movies/count", format = "html", title = "GET /movies/count")
    ...
    @See(href = "endpoint/moviefun-rest/GET/movies/", format = "html", title = "GET /movies")
